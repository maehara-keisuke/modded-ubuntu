...
package() {
    ...
    packs=(sudo wget curl nano git keyboard-configuration tzdata xfce4 xfce4-terminal librsvg2-common menu inetutils-tools dialog exo-utils tigervnc-standalone-server tigervnc-common dbus-x11 gtk2-engines-murrine gtk2-engines-pixbuf)
