...
setup_vnc() {
	if [[ -d "$CURR_DIR/distro" ]] && [[ -e "$CURR_DIR/distro/vncstart" ]]; then
		...
		downloader "$CURR_DIR/vncstart" "https://raw.githubusercontent.com/maehara-keisuke/modded-ubuntu/humble/distro/vncstart"
	...
	if [[ -d "$CURR_DIR/distro" ]] && [[ -e "$CURR_DIR/distro/vncstop" ]]; then
		...
		downloader "$CURR_DIR/vncstop" "https://raw.githubusercontent.com/maehara-keisuke/modded-ubuntu/humble/distro/vncstop"
...
permission() {
	...
	if [[ -d "$CURR_DIR/distro" ]] && [[ -e "$CURR_DIR/distro/user.sh" ]]; then
		...
		downloader "$CURR_DIR/user.sh" "https://raw.githubusercontent.com/maehara-keisuke/modded-ubuntu/humble/distro/user.sh"
